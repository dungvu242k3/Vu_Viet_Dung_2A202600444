        ...
        *,
        ...
        if self.use_llm_judge:
            ...
            if not judge_result["safe"]:
                ...
                error_msg = "I'm sorry, I cannot provide that information as it may violate security policies."
                llm_response.content.parts = [types.Part.from_text(text=error_msg)]
